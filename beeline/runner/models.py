...
class AlgorithmResult(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='algorithm_results', on_delete=models.CASCADE)
    dataset = models.ForeignKey('uploader.Dataset', related_name='algorithm_results', on_delete=models.CASCADE)
